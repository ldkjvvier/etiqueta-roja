		...
		<aside className="col-span-12 overflow-auto rounded-lg border bg-card p-4 lg:col-span-4">
			<div className="space-y-6">
				...
				<section className="space-y-4 rounded-lg border bg-muted/20 p-4">
							...
							<Textarea
								...
								onChange={(event) =>
									dispatch({
										type: 'setField',
										section: 'dropConfig',
										key: 'dropMessageTemplateScheduled',
										value: event.target.value,
									})
								}
								className="min-h-16"
						...
						{[
							...
							<div key={key} className="space-y-2">
								...
								<Select
									value={
										state.dropConfig[
											key as keyof HeroStudioState['dropConfig']
										]
											? 'true'
											: 'false'
									}
					...
					<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
						<ColorField
							label="Countdown (fondo)"
							id="drop_countdown_bg_color"
							value={state.dropConfig.dropCountdownBgColor}
							onChange={(value) =>
								dispatch({
									type: 'setField',
									section: 'dropConfig',
									key: 'dropCountdownBgColor',
									value,
								})
							}
						/>
						<ColorField
							label="Countdown (texto)"
							id="drop_countdown_text_color"
							value={state.dropConfig.dropCountdownTextColor}
							onChange={(value) =>
								dispatch({
									type: 'setField',
									section: 'dropConfig',
									key: 'dropCountdownTextColor',
									value,
								})
							}
						/>
						<ColorField
							label="LIVE badge (fondo)"
							id="drop_live_badge_bg_color"
							value={state.dropConfig.dropLiveBadgeBgColor}
							onChange={(value) =>
								dispatch({
									type: 'setField',
									section: 'dropConfig',
									key: 'dropLiveBadgeBgColor',
									value,
								})
							}
						/>
						<ColorField
							label="LIVE badge (texto)"
							id="drop_live_badge_text_color"
							value={state.dropConfig.dropLiveBadgeTextColor}
							onChange={(value) =>
								dispatch({
									type: 'setField',
									section: 'dropConfig',
									key: 'dropLiveBadgeTextColor',
									value,
								})
							}
						/>
				...
				<section className="space-y-4 rounded-lg border bg-muted/20 p-4">
					...
					<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
						...
						/>
						<ColorField
							label="Color Botón (fondo)"
							id="button_bg_color"
							value={state.styles.buttonBgColor}
							onChange={(value) =>
								dispatch({
									type: 'setField',
									section: 'styles',
					...
					<div className="space-y-2">
						<Label htmlFor="overlay_opacity">
							Overlay de Fondo ({state.styles.overlayOpacity}%)
						</Label>
						<Input
							id="overlay_opacity"
							type="range"
