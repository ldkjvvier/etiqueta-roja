...
export type VariantOptionValue = Database['public']['Tables']['variant_option_values']['Row']
export type Customer = Database['public']['Tables']['customers']['Row']
export type Order = Database['public']['Tables']['orders']['Row']
export type OrderItem = Database['public']['Tables']['order_items']['Row']
export type DailyMetrics = Database['public']['Tables']['daily_metrics']['Row']
export type ProductViewsDaily = Database['public']['Tables']['product_views_daily']['Row']
...
export type UpdateCustomer = Omit<
	...
	'id' | 'store_id' | 'auth_user_id' | 'total_spent' | 'deleted_at' | 'created_at'
>
